...
import sutd.istd.groupzero.gameobjects.CopyOfMonster_win.Direction;

import com.badlogic.gdx.Gdx;
import com.badlogic.gdx.math.Vector2;

public class CopyOfMonster_win {
	...
	public CopyOfMonster_win(int speed,  Vector2 currentMapPosition, Direction direction1, float screenWidth, float screenHeight)
	{
