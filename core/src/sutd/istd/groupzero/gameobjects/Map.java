...
public class Map {
    ...
    private int noOfObstacles = 10;private int noOfFood=5; private int noOfPowerUps=3;
	...
	private void generateObstacles() {
        ...
        for (int i = 0; i < noOfObstacles/2; i++) {
            ...
            obstaclesList.add(new Tree(new Vector2(r.nextInt(),r.nextInt())));
        }
        for (int i = 0; i < noOfObstacles/2; i++) {
            //creates noOfObstacles trees
            obstaclesList.add(new Boulder(new Vector2(r.nextInt(),r.nextInt())));
        }
    }

    private void genFood() {
        for (int i = 0; i < noOfFood; i++) {
            foodList.add(new Food(new Vector2(r.nextInt(20), r.nextInt(40))));
        }
    }
    ...
    private void genPowerUps()
    {
        ...
        {
            powerUpsList.add(new PowerUps(new Vector2(r.nextInt(20), r.nextInt(40))));
        }
